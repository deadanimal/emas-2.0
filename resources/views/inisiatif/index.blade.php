                    ...
                    @foreach ($inisiatif as $inisiatif)
                        <tr class="align-middle">
                            <td class="text-nowrap">
                                <div class="d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#error-modal-{{ $inisiatif->id }}">
                                    <div class="ms-2"><b>{{ $inisiatif->namaInisiatif }}</b></div>
                                </div>
                            </td>

                            <div class="modal fade" id="error-modal-{{ $inisiatif->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                                            ...
                                            <div class="p-4 pb-0">
                                                <form>
                                                    <div class="mb-3">
                                                        ...
                                                        <label class="form-control" disabled="disabled">{{ $inisiatif->namaInisiatif }}</label>

                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="col-form-label">Keterangan:</label>
                                                        <label class="form-control" disabled="disabled">{{ $inisiatif->keteranganInisiatif }}</label>
                                                    </div>
                                                </form>
                                                <br>
                                            </div>
