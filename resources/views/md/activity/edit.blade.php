        ...
        <div class="form-floating;">
            <form action="/activity/{{ $activity->id }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10" style="width:30%">
                        <input class="form-control" type="text" name="startDate" value="{{ $activity->startDate }}" />
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10" style="width:30%">
                        <input class="form-control" type="text" name="endDate" value="{{ $activity->endDate }}" />
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10" style="width:30%">
                        <input class="form-control" type="text" name="output" value="{{ $activity->output }}" />
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10" style="width:30%">
                        <input class="form-control" type="text" name="weightage" value="{{ $activity->weightage }}" />
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label" for="additionalOutput">Additional Output Information</label>
                    <div class="col-sm-10" style="width:30%">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10" style="width:30%">
                        <input class="form-control" type="text" name="remarks" value="{{ $activity->remarks }}" />
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10" style="width:30%">
                        <input class="form-control" type="file" name="document" value="{{ $activity->document }}" />
