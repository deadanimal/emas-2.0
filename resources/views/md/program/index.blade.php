...
@section('content')
    <div class="container">
        ...
        @role('admin|bahagian|kementerian')
            <a class="btn btn-falcon-default btn-sm" style="background-color: #047FC3; color:white" href="/program/create">
                            ...
                            @role('admin|bahagian|kementerian')
                                <td class="text-nowrap">
                                    <div>
                                        ...
                                        <button type="submit" onclick="myFunction({{ $program->id }})" class="btn btn-danger"
