...
@section('content')
    <div class="container">
        <div class="mb-4 text-center">
            <H2>DATA ENTRY FOR SUB ACTIVITY</H2>
        </div>
        ...
        <div class="form-floating;">
            <form action="{{ route('sub.store') }}" method="POST">
                ...
                <div class="mb-3">
                    <label class="form-label" for="keteranganSub"><b>Sub-Activity Information:</b></label>
                    <textarea class="form-control" name="keteranganSub" rows="5"></textarea>
                </div>
