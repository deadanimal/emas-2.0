                    ...
                    <div class="col-sm-10" style="width:30%">
                        <select class="form-control" name="fokus_id">
                            ...
                            @foreach ($fokus as $fokus)
                                <option @selected($tindakan->fokus_id == $fokus->id) value="{{ $fokus->id }}">{{ $fokus->namaFokus }}</option>
                            @endforeach
                    ...
                    <div class="col-sm-10" style="width:30%">
                        <select class="form-control" name="perkara_id">
                            ...
                            @foreach ($perkara as $perkara)
                                <option @selected($tindakan->perkara_id == $perkara->id) value="{{ $perkara->id }}">{{ $perkara->namaPerkara }}</option>
                            @endforeach
                    ...
                    <div class="col-sm-10" style="width:30%">
                        <select class="form-control" name="pemangkin_id">
                            ...
                            @foreach ($pemangkin as $pemangkin)
                                <option @selected($tindakan->pemangkin_id == $pemangkin->id) value="{{ $pemangkin->id }}">{{ $pemangkin->namaTema }}</option>
                            @endforeach
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10" style="width:30%">
                        <select class="form-control" name="bab_id">
                            ...
                            @foreach ($bab as $bab)
                                <option @selected($tindakan->bab_id == $bab->id) value="{{ $bab->id }}">Bab {{ $bab->noBab }}. {{ $bab->namaBab }}</option>
                            @endforeach
                    ...
                    <div class="col-sm-10" style="width:30%">
                        <select class="form-control" name="bidang_id">
                            ...
                            @foreach ($bidang as $bidang)
                                <option @selected($tindakan->bidang_id == $bidang->id) value="{{ $bidang->id }}">{{ $bidang->namaBidang }}</option>
                            @endforeach
                    ...
                    <div class="col-sm-10" style="width:30%">
                        <select class="form-control" name="strategi_id">
                            ...
                            @foreach ($strategi as $strategi)
                                <option @selected($tindakan->strategi_id == $strategi->id) value="{{ $strategi->id }}">{{ $strategi->namaStrategi }}</option>
                            @endforeach
